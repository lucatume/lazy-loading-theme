	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<header class="centered padded">
				...
				<p>If <a href="https://github.com/lucatume/wp-intercooler">wp-intercooler</a> and <a href="https://github.com/lucatume/wp-routes">wp-routes</a> plugins are active on the site are then lazy loading of images should happen.</p>
