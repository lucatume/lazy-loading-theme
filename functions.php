...
if ( ! function_exists( 'lazy_setup' ) ) :
	...
	function lazy_setup() {
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary Menu', 'lazy' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'lazy_custom_background_args', array(
...
function lazy_scripts() {
	...
	wp_enqueue_script( 'lazy-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'lazy-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
